...
from website.tools.case_styles import CaseManager
...
class ReaderBuilder(TextBuilder):
    ...
    def get_name(self, obj: bnf.TopLevel) -> Variable:
        ...
        name = str(obj.type)
        if CaseManager.matches(name, CaseManager.Styles.PASCAL_CASE):
            name = CaseManager.convert(name, CaseManager.Styles.PASCAL_CASE, CaseManager.Styles.SCREAM_CASE)
        elif CaseManager.matches(name, CaseManager.Styles.SCREAM_CASE):
            name = CaseManager.convert(name, CaseManager.Styles.SCREAM_CASE, CaseManager.Styles.SCREAM_CASE)
        else:
